    ...
    Card(
        ...
        Row(
            ...
            Column(
                ...
                val occurrenceText = when (event.eventType) {
                    EventType.SINGLE -> "Once"
                    EventType.ROUTINE -> {
                    ...
                    EventType.STREAK -> {
                        "${event.getStreakDays()} days streak"
                    }
                }
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            EventItem(
                event = Event(
                    id = "3",
                    title = "No smoking",
                    description = "No smoking streak",
                    eventType = EventType.STREAK,
                    occurrenceType = OccurrenceType.ONCE,
                    repeatType = null,
                    repeatFrequency = null,
                    lastExecutionTimestamp = System.currentTimeMillis()-(1_000*60*60*24*6),//   6 days
